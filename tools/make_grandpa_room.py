...
def main():
    ...
    out = out.rstrip("\n") + (
        '\n\n[node name="FacadeFader" type="Node3D" parent="."]\n'
        'transform = Transform3D(%s, 4.65, 1, 3.34)\n'
        'script = ExtResource("40_roofm")\n'
        'roof_path = NodePath("../GrandpaShell/Spots/front_boards")\n'
        'interior_extents = Vector3(9.4, 1.8, 5.1)\n' % I)
